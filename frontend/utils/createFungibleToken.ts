...
const operatorId = AccountId.fromString(process.env.NEXT_PUBLIC_APP_OPERATOR_ID);
const operatorKey = PrivateKey.fromString(process.env.NEXT_PUBLIC_APP_OPERATOR_PVKEY);
const treasuryId = AccountId.fromString(process.env.NEXT_PUBLIC_APP_OPERATOR_ID);
const treasuryKey = PrivateKey.fromString(process.env.NEXT_PUBLIC_APP_OPERATOR_PVKEY);
const aliceId = AccountId.fromString(process.env.NEXT_PUBLIC_APP_ALICE_ID);
const aliceKey = PrivateKey.fromString(process.env.NEXT_PUBLIC_APP_ALICE_PVKEY);
